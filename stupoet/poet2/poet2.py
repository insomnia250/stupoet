...
preds = layers.TimeDistributed(layers.Dense(vocab_size, activation='softmax'))(lstm_output)
...
## 权值个数计算: 
print 'weights num', vocab_size*EMBEDDING_units + LSTM_cells*4*(LSTM_cells+EMBEDDING_units+1) + LSTM_cells*vocab_size*poem_maxlen
