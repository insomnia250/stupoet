...
lstm2_output = recurrent.LSTM(LSTM2_cells,return_sequences=True,implementation = 2)(lstm1_output) #(M,X_train.shape[1],LSTM2_cells)
...
print 'weights num', vocab_size*EMBEDDING_units + LSTM1_cells*4*(LSTM1_cells+EMBEDDING_units+1) \
		+ LSTM2_cells*4*(LSTM2_cells+LSTM1_cells+1) + LSTM2_cells*vocab_size*X_train.shape[1]
